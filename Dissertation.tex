...
pdftitle = {Novel strategies for high-throughput data analysis in computational proteomics and proteogenomics},
pdfsubject = {},
pdfkeywords = {},
pdfcreator = {LaTeX},
...
\nomenclature{HUPO}{Human Proteome Organisation}
...
\nomenclature{SILAC}{stable isotope labeling with amino acids in cell culture}
...
\nomenclature{TOPP}{The OpenMS Proteomics Pipeline}
\nomenclature{TPP}{Trans-Proteomic Pipeline}
