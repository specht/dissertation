...
questions, including the characterization of the \cre~chloroplast proteome
and its anaerobic response.
In addition, a re-designed version of the Genomic Peptide Finder was used
to establish a high-throughput proteogenomic genome annotation pipeline.
