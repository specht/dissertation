...
A central aspect of \cre~research is photosynthesis which takes place in the 
chloroplast.
\cre~possesses a single chloroplast which fills two thirds of the cell.
The hypothesis that chloroplasts have originated from cyanobacteria and been 
incorporated via endosymbiosis \citep{Gould2008} is supported by the fact 
that chloroplasts contain their own DNA.
...
to the nuclear genome \citep{Blanchard2000}.
...
detailed insight into the anaerobic response of the chloroplast proteome in
the green alga.
