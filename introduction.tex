...
Two well-established methods for this task exist: 
(1) matrix-assisted laser desorption/ionization (MALDI) for solid analytes,
and (2) electrospray ionization (ESI) for liquid samples.
% MALDI
In the MALDI approach, the analyte is mixed with a matrix material and 
co-cristallized on a metal plate. 
...
upstream LC system because it works with fluid samples.
